...
public static class SEPath{
	...
	public const string IRON_DEATH       = "SE/02_Hit/iron_death";
	...
	public const string RIFLE_SKILL2     = "SE/04_Rifle/rifle_skill2";
	public const string RIFLE_SKILL3     = "SE/04_Rifle/rifle_skill3";
	public const string SWORD_ATK        = "SE/03_Sword/sword_atk";
	public const string SWORD_DASHATK    = "SE/03_Sword/sword_dashatk";
	public const string SWORD_HIT        = "SE/02_Hit/sword_hit";
	public const string SYSTEM20         = "SE/system20";
	public const string SYSTEM23         = "SE/system23";
	public const string TITLE_NOISE      = "SE/01_Title/Title_Noise";
	public const string TITLE_WIND       = "SE/01_Title/Title_Wind";
	public const string UDEBUNNMAWASI    = "SE/02_Hit/udebunnmawasi";
	public const string WORM_DEATH       = "SE/02_Hit/worm_death";
