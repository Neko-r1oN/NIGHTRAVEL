...
public class RoomModel : BaseModel, IRoomHubReceiver
{
    ...
    /// Aughter:木田晃輔
    /// </summary>
    public void OnLevelUp(int level, int nowExp, CharacterStatusData updatedStatusData, Guid optionsKey, List<StatusUpgrateOptionData> statusOptionList)
    {
        OnLevelUpSyn(level,nowExp, updatedStatusData, optionsKey, statusOptionList);
    }
