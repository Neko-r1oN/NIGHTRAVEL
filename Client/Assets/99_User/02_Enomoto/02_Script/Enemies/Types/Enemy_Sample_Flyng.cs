...
//    {
//        // 行動パターン
//        if (canAttack && projectileChecker.CanFireProjectile(target, throwableObject.GetComponent<SpriteRenderer>().bounds.size.y / 2, true) && !sightChecker.IsObstructed() && attackType != ATTACK_TYPE_ID.None)
//        {
//            chaseAI.Stop();
//            Attack();
//        }
...
//        {
//            projectileChecker.DrawProjectileRayGizmo(target, throwableObject.GetComponent<SpriteRenderer>().bounds.size.y / 2, true);
//        }
