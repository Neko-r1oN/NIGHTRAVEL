...
namespace NIGHTRAVEL.Shared.Interfaces.Model.Entity
{
    ...
    public class Enemy
    {
        ...
        public float defence { get; set; }                 //敵の防御力
        public int power { get; set; }                  //敵の攻撃力
        public float jump_power { get; set; }              //敵の跳躍力
        public float move_speed { get; set; }              //敵の移動速度
        public float attack_speed_factor { get; set; }           //敵の攻撃速度
