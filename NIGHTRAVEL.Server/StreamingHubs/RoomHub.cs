...
namespace StreamingHubs
{
    public class RoomHub(RoomContextRepository roomContextRepository) : StreamingHubBase<IRoomHub, IRoomHubReceiver>, IRoomHub
    {
        ...
        public async Task ShootBulletAsync(EnumManager.PROJECTILE_TYPE type, List<EnumManager.DEBUFF_TYPE> debuffs, int power, Vector2 spawnPos, Vector2 shootVec)
        {
            // 参加者全員に端末の結果を通知
            this.roomContext.Group.All.OnShootBullet(type, debuffs, power, spawnPos, shootVec);
        }
